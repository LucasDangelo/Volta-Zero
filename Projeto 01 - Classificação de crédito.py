...
# O gráfico bivariado anterior tem correlação entre a proporção de inadimplencia e o tempo de emprego, levando em consideração a taxa 'mau' exposta na tabela de dados dos clientes.
